        ...
        <div className='main-doc-container'>
            <div className='form-sections'>
                ...
                <form onSubmit={isEditMode ? (e) => handleUpdateDoctor(selectedDoctor._id, e) : handleAddDoctor}>
                    ...
                    <br />
                    <label>Degree: </label>
                    <input type="text" value={isEditMode ? selectedDoctor.degree : newDoctor.degree}
                        onChange={(e) => isEditMode ? setSelectedDoctor({ ...selectedDoctor, degree: e.target.value }) : setNewDoctor({ ...newDoctor, degree: e.target.value })} />
                    <br />
                    <label>Days of Availability: </label>
                    <input type="text" value={isEditMode ? selectedDoctor.daysOfAvailability : newDoctor.daysOfAvailability}
                        onChange={(e) => isEditMode ? setSelectedDoctor({ ...selectedDoctor, daysOfAvailability: e.target.value }) : setNewDoctor({ ...newDoctor, daysOfAvailability: e.target.value })} />
                    <br />
                    <label>Consultation Fees: </label>
                    <input type="number" value={isEditMode ? selectedDoctor.consultationFees : newDoctor.consultationFees}
                        onChange={(e) => isEditMode ? setSelectedDoctor({ ...selectedDoctor, consultationFees: e.target.value }) : setNewDoctor({ ...newDoctor, consultationFees: e.target.value })} />
                    <br />
